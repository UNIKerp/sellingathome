...
class ProduitSelligHome(models.Model):
    ...
    def creation_produit_odoo_sah(self,objet,is_published,type,allow_out_of_stock_order,sale_ok,is_storable,categ_id,
        ...
        _logger.info("22222222222222222222222222222222222")
    ...
    def maj_des_photos_produits(self,product_id):
        ...
        if response_produit.status_code == 200:
            ...
            for photo in values['ProductPhotos']:
                photo["Link"] = "https://demoseller.sellingathome.com/api/s3/sah-files/products/120781/87-26-2f-33-ed-3a-21-f5-62-12-4a-20-34-7f-27-1e-98-76-e9-76.png"
            _logger.info('================================= aprss%s',values)
            url_put = f"https://demoapi.sellingathome.com/v1/Products/120781"
