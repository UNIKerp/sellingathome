...
class ClientSAH(models.Model):
    ...
    is_customer = fields.Boolean("Est vendeur")
                ...
                if client_odoo:
                    ...
                    if clients_sah['CompanyName']:
                        ...
                        self.create({
                            ...
                            #'':clients_sah['Gender'],
                            'is_seller':True,
                            'name':clients_sah['Lastname']+clients_sah['Firstname'],
                            'email':clients_sah['Email'],
                            'phone':clients_sah['Phone'],
                            'mobile':clients_sah['MobilePhone'],
                            #'':clients_sah['Birthdate'],
